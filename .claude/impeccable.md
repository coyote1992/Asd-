...
→ _Consult typography reference for OpenType features, web font loading, and the deeper material on scales._
...
→ _Consult color reference for the deeper material on contrast, accessibility, and palette construction._
...
→ _Consult spatial reference for the deeper material on grids, container queries, and optical adjustments._
...
*   FORBIDDEN: any border-left or border-right wider than 1px used as a decorative accent stripe
*   REWRITE: use a different element structure entirely. Reach for full borders, background tints, leading numbers/icons, or no visual indicator at all.

**BAN 2: Gradient text**

*   PATTERN: `background-clip: text` combined with a gradient background
*   FORBIDDEN: any combination that makes text fill come from a gradient
...
*   Use bounce or elastic easing. They feel dated and tacky
...
Match implementation complexity to the aesthetic vision. Interpret creatively and make unexpected choices that feel genuinely designed for the context. No design should be the same. Vary between light and dark themes, different fonts, different aesthetics. NEVER converge on common choices across generations.

---

## Craft Mode

If invoked with "craft" (e.g., `/impeccable craft [feature description]`), follow the craft flow.

---

## Teach Mode

If invoked with "teach" (e.g., `/impeccable teach`), skip design work and instead gather design context:

### Step 1: Explore the Codebase
Scan README, package.json, existing components, brand assets, design tokens.

### Step 2: Ask UX-Focused Questions
Ask only what you couldn't infer:
- Who uses this? What's their context?
- Brand personality in 3 words?
- Reference sites? Anti-references?
- Light, dark, or both?

### Step 3: Write Design Context

Write a `## Design Context` section to `.impeccable.md`:
...
If invoked with "extract" (e.g., `/impeccable extract [target]`), pull reusable components and tokens into the design system.
